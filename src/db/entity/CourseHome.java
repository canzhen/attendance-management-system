...
public class CourseHome {
	...
	public Course findById(java.lang.String id) {
		...
		try {
			Course instance = (Course) sessionFactory.getCurrentSession().get("db.entity.Course", id);
			if (instance == null) {
	...
	public List findByExample(Course instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("db.entity.Course")
