...
public class TcId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		return ((this.getTno() == castOther.getTno())
				|| (this.getTno() != null && castOther.getTno() != null && this.getTno().equals(castOther.getTno())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getTno() == null ? 0 : this.getTno().hashCode());
